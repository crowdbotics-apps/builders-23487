"""builders_23487 URL Configuration
...
admin.site.site_header = "builders"
admin.site.site_title = "builders Admin Portal"
admin.site.index_title = "builders Admin"

# swagger
api_info = openapi.Info(
    title="builders API",
    default_version="v1",
    description="API documentation for builders App",
)
